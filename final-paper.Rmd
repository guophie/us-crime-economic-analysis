...
comparisons = compare.fit %>%
  kbl(caption = "Comparison of MSE, RMSE, MAE, Adjusted R-Squared: Stepwise Models") %>%
  kable_styling()
comparisons
```
...
#html table
compare.violent %>%
  kbl(caption = "Comparison of MSE, RMSE, MAE, Adjusted R-Squared: Violent Crime Models") %>%
  kable_styling()
...
#html table
compare.property %>%
  kbl(caption = "Comparison of MSE, RMSE, MAE, Adjusted R-Squared: Property Crime Models") %>%
  kable_styling()
# arrange plots
...
model_metrics %>%
  kbl(caption = "Comparison of models predicting poverty rate") %>%
  kable_styling()
```
```{r, echo = FALSE}
